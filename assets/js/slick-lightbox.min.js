...
!(function (t) {
  ...
  (i = (function () {
    ...
    /* mreq note: Creates the lightbox, opens it, binds events and calls `slick`. Accepts `index` of the element, that triggered it (so that we know, on which slide to start slick). */
    return (
      ...
      (i.prototype.createModalItems = function () {
        ...
        var i, n, o, e, s, l;   /* mreq notation.. var $items, createItem, itemTemplate, lazyPlaceholder, length, links; */
        return (
          (e =
      ...
      (i.prototype.createModal = function () {
        /* Creates a `slick`-friendly modal. SlickLightbox.prototype.createModal = function () { var html, links;*/
        var i, n;
        return (
